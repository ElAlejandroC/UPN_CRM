...
// Funcion PDF
app.get('/api/generar-pdf/:id', async (req, res) => {
    ...
    db.query(sql, [inscritoId], async (err, results) => {
        ...
        try {
            const existingPdfBytes = fs.readFileSync('Model/Materiales/plantilla3.pdf');
            ...
            const parte3 = { text:'en el marco de la XVIII Jornada Académica, Cultural y de Salud; desarrollada en la UPN Unidad 22-A Queréraro.', fontType: 'normal' };
            ...
            res.setHeader('Content-Disposition', `attachment; filename=constancia_${inscritoId}.pdf`);
